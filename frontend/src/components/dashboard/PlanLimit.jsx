        ...
        {allBoughtPlan &&
          allBoughtPlan.map((planData, i) => {
            return (
              <div
                key={i}
                className="drop-shadow-xl mr-8  mx-auto  text-center w-3/4  md:w-2/5 bg-white rounded-lg p-4 m-4"
              >
                    ...
                    <div className="w-full pt-1 mx-auto mt-4">
                      ...
                      <div className="overflow-hidden w-full   h-2 mb-4 text-xs flex rounded bg-blue-200">
                        <div
                          style={{
                            width: `${
                              planData.leftFiles * (100 / planData.Plan.files)
                            }%`,
                          }}
                    ...
                    <div className="w-full pt-1 mx-auto mt-4">
                      ...
                      <div className="overflow-hidden w-full   h-2 mb-4 text-xs flex rounded bg-blue-200">
                        <div
                          style={{
                            width: `${
                              planData.leftData * (100 / planData.Plan.data)
                            }%`,
                          }}
                          className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500 transition-all duration-500 ease-in-out"
                        ></div>
                    ...
                    <div className="w-full pt-1 mx-auto mt-4">
                      ...
                      <div className="overflow-hidden w-full   h-2 mb-4 text-xs flex rounded bg-blue-200">
                        <div
                          style={{
                            width: `${
                              planData.leftValidity * (100 / planData.Plan.days)
                            }%`,
                          }}
                          className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500 transition-all duration-500 ease-in-out"
                        ></div>
